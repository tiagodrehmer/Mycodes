...
node_category_t* aplication_for_files_fuction (FILE* arquivo, char opcao, node_category_t* root_category); //funcao para auxilio das funcoes q precisam de abertura de arquivos
